...
class Accretion:
    ...
    def linefluxErrorProp(self, SpTyUnc, distUnc, ageUnc, AvUnc, linefluxUnc, numMC, Rin=5, RinUnc=0, line=None, A=None, AUnc=None, B=None, BUnc=None, age_scatter=False):
            #propagate errors forward and obtain uncertainty distributions
            if line == None:
                A = A
                aUnc = AUnc
...
class AccretionDistribution:
    ...
    def linefluxErrorProp(self, SpTyUnc, distUnc, ageUnc, AvUnc, linefluxUnc, numMC, Rin=5, RinUnc=0, line=None, A=None, AUnc=None, B=None, BUnc=None, age_scatter=False):
        for acc in self.accretion_distribution:
            acc.linefluxErrorProp(SpTyUnc, distUnc, ageUnc, AvUnc, linefluxUnc, numMC, Rin=Rin, RinUnc=RinUnc, line=line, A=A, AUnc=AUnc, B=B, BUnc=BUnc, age_scatter=agescatter)
